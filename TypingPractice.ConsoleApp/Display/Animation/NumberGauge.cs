...
{
    internal class NumberGauge : Animation
    {
        ...
        public NumberGauge(ConsoleColor dialColor, ConsoleColor borderColor, ConsoleColor backgroundColor, double maxThreshold, Func<double> funcGetCurrentValue)
        {
